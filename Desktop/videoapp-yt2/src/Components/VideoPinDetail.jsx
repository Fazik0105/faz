          ...
          <GridItem width={"100%"} colSpan="42">
            ...
            >
              ...
              >
                ...
                >
                  {!isPlaying && (
                    <IoPlay fontSize={40} color="#f2f2f2" cursor={"pointer"} />
                  )}
                </Flex>
                <MdFullscreen
                  fontSize={30}
                ...
                >
                  ...
                  <Flex width={"full"} alignItems="center" my={2} gap={10}>
                    ...
                    <Box onClick={() => setIsPlaying(!isPlaying)} marginLeft={"-50px"}>
                      {!isPlaying ? (
                        <IoPlay
                          fontSize={30}
                          color="#f2f2f2"
                    ...
                    {/* duration of video */}
                    <Flex alignItems={"center"} gap={0.5} marginLeft={"-40px"}>
                      <Text fontSize={12} color="whitesmoke">
                        {elapsedTime}
                      </Text>
                    ...
                    <Image src={logo} width={"30px"} ml="auto" gap={5} marginLeft={"-8"}/>
                  </Flex>
                </Flex>
              </Flex>
            </Flex>
